...
2. Isi jam **Dari** dan **Sampai** (format 24 jam, zona **WIB/GMT+7**). Rentang ini hanya dipakai di hari yang **tidak dicentang**: **OFF** di dalam jam, **ON** di luar jam.
...
5. **Prioritas hari aktif:** hari yang dicentang = maintenance **ON** terus. Hari yang tidak dicentang: **OFF** di dalam jam Dari/Sampai, **ON** di luar jam. Rentang yang melewati tengah malam (mis. 16:30–08:00) juga didukung.

Baris **Status** menunjukkan keadaan saat ini: mis. *"AKTIF otomatis (hari aktif sepanjang hari, Sen, Sel, Kam, Jum, Min)"* atau *"NONAKTIF — dalam jam 09:00-17:00 WIB"*.
