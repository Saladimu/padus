...
- **Pengaturan Admin**: kunci kata sandi, ganti kata sandi, atur URL backend, rentang **Tahun ekskul padus** (MM-YYYY) yang membatasi laporan, dan **Test Koneksi** (action `ping`).
